...
import EstudioList from '@/components/servicios/EstudioList'
...
export async function generateMetadata (): Promise<Metadata> {
  const pageInfo = await getPageInfo('studio')
